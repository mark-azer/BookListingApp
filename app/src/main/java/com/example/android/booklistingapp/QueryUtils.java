...
public final class QueryUtils {
     ...
     */
    private static ArrayList<Book> extractDataFromJson(String booksJSON) {
        ...
        try {
            ...
            for (int i = 0; i < bookArray.length(); i++) {
                ...
                // key called "volumeInfo", which represents a list of all volume
                ...
                boolean hasAuthors = volumeInfo.has("authors");
                ...
                if (hasAuthors) {
                    ...
                    // Extract the strings of the author names into a String array
